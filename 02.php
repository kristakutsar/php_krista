...
<html lang="et">
    ...
    <div class="container">
        ...
        //head mõtted
            function headmotted(){
                 $alus = array ("Mari","Kati","Malle");
                 $oeldis = array ("teeb","ütleb","kuulab");
                 $sihitis = array ("keda","mida","kellega");
...
// TSÜKKEL TSÜKLIS, kui on mitmemõõtmeline massiiv
        ...
        ?>
            ...
            <h1>Massiivid</h1>
        <?php
            $nimed = array("Mari","Kati","Malle","Juuli","Maali");
            ...
            echo "Viimane nimi: " .$nimed[count($nimed)-1]."<brr>";
            ...
            $arv = count($autod);
            //echo "Autode arv: ".$arv."<br>";

            $arv2 = count($vinkoodid);
            //echo "Vin koodid: " .$arv2;
            
            if ($arv==$arv2) {
                echo "Autod ja vin koodid klapivad";
            } else{
                echo "Autod ja vin koodid ei klapi";
            }
            echo "<br> -------------------- <br>";
